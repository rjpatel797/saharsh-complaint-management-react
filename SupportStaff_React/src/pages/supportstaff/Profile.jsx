...
const Profile = () => {
    ...
    if (loading) {
        return (
            <div className="h-full bg-gradient-to-br from-gray-50 to-white flex items-center justify-center p-4">
    ...
    return (
        <div className="h-full bg-gradient-to-br from-gray-50 to-white overflow-hidden">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 h-full flex flex-col">
                {/* Header Section */}
                <div className="mb-3 flex-shrink-0">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        <div>
                            <h1 className="text-xl font-bold text-gray-900 mb-0.5 flex items-center">
                                <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center mr-2 shadow-md">
                                    <User className="w-4 h-4 text-white" />
                                </div>
                                My Profile
                            </h1>
                            <p className="text-gray-600 text-xs ml-10">Manage your account information and settings</p>
                        </div>
                        <div className="flex space-x-2">
                            <button
                                onClick={() => loadProfile(true)}
                                disabled={refreshing || loading}
                                className="px-2.5 py-1.5 bg-white border border-gray-300 text-gray-700 rounded-lg text-xs font-medium hover:bg-gray-50 transition-all flex items-center space-x-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            <button
                                ...
                                className="px-2.5 py-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg text-xs font-semibold hover:from-blue-600 hover:to-indigo-600 transition-all flex items-center space-x-1.5 shadow-md hover:shadow-lg"
                            >
                ...
                {/* Profile Hero Card */}
                <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-3 border border-gray-200 flex-shrink-0">
                    <div className="bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 p-3.5">
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-3">
                            ...
                            <div className="flex-1 text-center md:text-left min-w-0">
                                <h2 className="text-lg font-bold text-white mb-0.5 truncate">{profile.fullname || profile.username || 'N/A'}</h2>
                                <p className="text-blue-50 text-xs mb-1.5 truncate">@{profile.username || 'N/A'}</p>
                                
                                {/* Status Badge */}
                                <div className="inline-flex items-center px-2 py-0.5 bg-cyan-100/30 backdrop-blur-sm rounded-full border border-cyan-200/40">
                                    <div className={`w-1.5 h-1.5 rounded-full mr-1.5 flex-shrink-0 ${isActive ? 'bg-teal-400 animate-pulse' : 'bg-red-400'}`}></div>
                            ...
                            {/* Quick Stats */}
                            <div className="grid grid-cols-2 gap-2 md:grid-cols-1 flex-shrink-0">
                                <div className="bg-blue-400/20 backdrop-blur-sm rounded-lg p-2 border border-blue-300/30">
                                    <p className="text-blue-50 text-xs mb-0.5">Staff ID</p>
                                    <p className="text-white text-base font-bold">{profile.supportStaffId || 'N/A'}</p>
                                </div>
                                <div className="bg-blue-400/20 backdrop-blur-sm rounded-lg p-2 border border-blue-300/30">
                                    <p className="text-blue-50 text-xs mb-0.5">Role</p>
                                    <p className="text-white text-base font-bold truncate">{profile.role || 'N/A'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-3">
                    {/* Contact Information */}
                    <div className="bg-white rounded-xl shadow-md p-3.5 border border-gray-200 hover:shadow-lg transition-shadow">
                        <div className="flex items-center mb-3">
                            <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                                <Phone className="w-5 h-5 text-white" />
                            </div>
                            <h3 className="text-base font-bold text-gray-800">Contact Information</h3>
                        </div>
                        <div className="space-y-2">
                            <div className="flex items-start space-x-2.5 p-2.5 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                <Phone className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" />
                                <div className="flex-1 min-w-0">
                                    <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Phone Number</p>
                                    <p className="text-gray-900 font-medium text-sm break-words">{profile.contactNumber || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-2.5 p-2.5 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-3.5 border border-gray-200 hover:shadow-lg transition-shadow">
                        <div className="flex items-center mb-3">
                            <div className="w-9 h-9 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-start space-x-2.5 p-2.5 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-gray-900 font-medium text-sm break-words">{profile.username || 'N/A'}</p>
                                </div>
                            </div>
                            <div className="flex items-start space-x-2.5 p-2.5 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 flex-shrink-0">
                    <div className="bg-white rounded-xl shadow-md p-3.5 border border-gray-200">
                        <div className="flex items-center mb-3">
                            <div className="w-9 h-9 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                                <Calendar className="w-5 h-5 text-white" />
                            </div>
                            <h3 className="text-base font-bold text-gray-800">Registration</h3>
                        </div>
                        <div className="flex items-center space-x-2.5 p-2.5 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100">
                            <Clock className="w-4 h-4 text-green-600 flex-shrink-0" />
                            <div className="min-w-0 flex-1">
                                <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Registration Date</p>
                                <p className="text-gray-900 font-medium text-sm break-words">{formatDate(profile.createDate)}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl shadow-md p-3.5 border border-gray-200">
                        <div className="flex items-center mb-3">
                            <div className="w-9 h-9 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                                <Clock className="w-5 h-5 text-white" />
                            </div>
                            <h3 className="text-base font-bold text-gray-800">Last Updated</h3>
                        </div>
                        <div className="flex items-center space-x-2.5 p-2.5 bg-gradient-to-r from-orange-50 to-red-50 rounded-lg border border-orange-100">
                            <Clock className="w-4 h-4 text-orange-600 flex-shrink-0" />
                            <div className="min-w-0 flex-1">
                                <p className="text-xs text-gray-500 uppercase font-semibold mb-1">Last Update</p>
                                <p className="text-gray-900 font-medium text-sm break-words">{formatDate(profile.updateDate) || 'Never updated'}</p>
                            </div>
                        </div>
                    </div>
                </div>
