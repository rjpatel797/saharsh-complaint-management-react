        ...
        <div className="space-y-6 animate-fade-in text-gray-800">
            ...
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 bg-white p-4 rounded-3xl shadow-sm border border-gray-100">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-black text-slate-800 tracking-tight">Ticket Master Report</h2>
                        <p className="text-xs text-gray-400 font-bold uppercase tracking-widest mt-0.5">Audit Trail & Performance History</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4 items-end">
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
                        ...
                        <div className="form-control relative" ref={staffDropdownRef}>
                            <label className="label py-0.5">
                                <span className="label-text font-black text-slate-400 uppercase text-[9px] tracking-widest px-1 flex items-center gap-1">
                                    <Users size={12} /> Filter by Staff
                                </span>
                            </label>
                            <input
                                type="text"
                                placeholder="Search support staff..."
                                className="w-full px-3 py-2 h-10 border border-gray-300 rounded-lg bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                            ...
                            />
                            {showStaffDropdown && (
                                <div className="absolute top-[calc(100%+4px)] left-0 right-0 max-h-60 overflow-y-auto bg-white border border-gray-100 shadow-2xl rounded-2xl z-[50] py-2 animate-fade-in">
                                    {staffLoading ? (
                                        <div className="p-4 text-center text-[10px] font-bold text-gray-400 uppercase tracking-widest">Waking Up Roster...</div>
                                    ) : supportStaff.length === 0 ? (
                                        <div className="p-4 text-center text-gray-400 italic text-sm">No staff records found.</div>
                                    ) : (
                                        supportStaff
                                            ...
                                            .map((s) => (
                                                <button
                                                    ...
                                                    className="w-full text-left px-4 py-2 hover:bg-slate-50 text-sm font-bold text-slate-600 transition-colors"
                                                >
                                                    {s.staffName}
                                                </button>
                                            ))
                                ...
                                <tr>
                                    <td colSpan="21" className="py-32">
                                        <div className="flex flex-col items-center opacity-40">
                                            ...
                                            <p className="mt-4 text-sm font-medium text-slate-900">No Data Found for Your earch Criteria.</p>
                                        </div>
                                    </td>
                                </tr>
                            ) : (
                                currentRecords.map((r, idx) => {
                                    ...
                                    return (
                                        <tr key={idx} className="hover:bg-slate-50/50 transition-colors border-b border-slate-50 last:border-0">
                                            <td className="text-sm font-bold text-slate-300 text-center whitespace-nowrap py-4 px-4">{(currentPage * pageSize) + idx + 1}</td>
