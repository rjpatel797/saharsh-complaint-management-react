                    ...
                    <table className="w-full border-collapse min-w-full">
                        <thead className="bg-gradient-to-r from-gray-50 to-gray-100 sticky top-0 z-10 shadow-md">
                            <tr>
                                ...
                                <th className="whitespace-nowrap py-2 px-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider border-b-2 border-gray-200">STAFF IDENTITY</th>
                                <th className="whitespace-nowrap py-2 px-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider border-b-2 border-gray-200">PASSWORD</th>
                                <th className="whitespace-nowrap py-2 px-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider border-b-2 border-gray-200">COMMUNICATION EMAIL</th>
                                <th className="whitespace-nowrap py-2 px-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider border-b-2 border-gray-200">CONTACT VECTOR</th>
                                <th className="whitespace-nowrap py-2 px-3 text-center text-xs font-bold text-gray-700 uppercase tracking-wider border-b-2 border-gray-200">LIFECYCLE STATUS</th>
