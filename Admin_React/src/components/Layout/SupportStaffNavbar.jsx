...
const SupportStaffNavbar = () => {
    ...
    useEffect(() => {
        ...
        style.textContent = `
            ...
            .count-animate {
                animation: count-pop 0.8s ease-in-out;
            }
        `;
            ...
            <div className="px-4 py-2">
                <div className="flex items-center justify-between h-14">
                    ...
                    <div className="flex items-center space-x-2 flex-shrink-0">
                        ...
                        <span className="text-xl font-bold whitespace-nowrap">Support Staff</span>
                    </div>
                    ...
                    <div className="hidden md:flex flex-1 items-center justify-center px-8 space-x-2">
                        ...
                        >
                            ...
                            <span className="mr-2">
                                {isActive('/support/dashboard') ? <Menu size={18} className="text-white" /> : <LayoutDashboard size={18} />}
                            </span>
                            <span className={`text-sm ${isActive('/support/dashboard') ? 'text-white font-bold' : ''}`}>Dashboard</span>
                        </Link>
                        ...
                        <div className="relative group">
                            ...
                            >
                                ...
                                <span className="mr-2">
                                    {isActive('/support/reports') ? <Menu size={18} className="text-white" /> : <FileText size={18} />}
                                </span>
                                <span className={`text-sm ${isActive('/support/reports') ? 'text-white font-bold' : ''}`}>Reports</span>
                            ...
                            <div className="absolute top-full left-0 mt-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                <ul className="bg-[#3b0764] rounded-xl shadow-2xl border border-purple-700 w-56 py-2">
                                    <li>
                                        <Link 
                        ...
                        >
                            ...
                            <span className="mr-2">
                                {isActive('/support/profile') ? <Menu size={18} className="text-white" /> : <User size={18} />}
                            </span>
                            <span className={`text-sm ${isActive('/support/profile') ? 'text-white font-bold' : ''}`}>Profile</span>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center space-x-3 flex-shrink-0">
                        ...
                        {isDashboard && (
                            <div className="hidden md:block relative" ref={notificationRef}>
                                <button
                                    ...
                                    className={`w-10 h-10 bg-purple-700 hover:bg-purple-600 text-purple-200 rounded-lg flex items-center justify-center transition-all duration-200 relative ${bellAnimation ? 'bell-animate' : ''}`}
                                >
                                    <Bell size={20} />
                                    {notificationCount > 0 && (
                        ...
                        {/* Mobile toggle */}
                        <button 
                            className="md:hidden text-purple-200 hover:text-white transition-colors p-2" 
